...
parser = argparse.ArgumentParser(description='Arguments for DANIEL_Scheduling')
# args for device
...
parser.add_argument('--act_per_proj', type=float, default=0,
                    help='Number of activities per project, default 0, means the number equals t')
parser.add_argument('--act_per_team_min', type=int, default=1,
                    help='Minimum number of compatible teams for each activity')
parser.add_argument('--act_per_team_max', type=int, default=5,
                    help='Maximum number of compatible teams for each activity')
...
# args for env
parser.add_argument('--n_p', type=int, default=10, help='Number of projects of the instance')
parser.add_argument('--n_t', type=int, default=5, help='Number of teams of the instance')
parser.add_argument('--n_act', type=int, default=50, help='Number of activities of the instance')
...
# args for network
parser.add_argument('--fea_act_input_dim', type=int, default=10, help='Dimension of activity raw feature vectors')
parser.add_argument('--fea_team_input_dim', type=int, default=8, help='Dimension of team raw feature vectors')

parser.add_argument('--dropout_prob', type=float, default=0.0, help='Dropout rate (1 - keep probability).')

parser.add_argument('--num_heads_AAB', nargs='+', type=int, default=[4, 4],
                    help='Number of attention head of activity message attention block')
parser.add_argument('--num_heads_TAB', nargs='+', type=int, default=[4, 4],
                    help='Number of attention head of team message attention block')
